...
\cfoot{}
  \begin{flushright}
    \heiti \textbf{论文编码：RUC-BK-020104T-XXXXXXXXXX}
  \end{flushright}
...
\begin{abstract}
\begin{spacing}{1.5}
此处撰写中文摘要。重点阐述研究背景、因果推断方法、核心政策评估结果以及结论。
\\[12pt]
...
\begin{enabstract}
\begin{doublespace}
This is the abstract. It summarizes the background, methodology (e.g., causal inference, spatial data analysis), and main results.
\\[12pt]
